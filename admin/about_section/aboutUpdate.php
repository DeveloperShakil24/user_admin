				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">About Update</h5>
						...
						<div class="panel-body">
							...
							$getSingelDataQry = "SELECT * FROM about_section WHERE id={$about_id}";
							...
							<form class="form-horizontal mt-10" action="../controller/aboutController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group">
									...
									<?php
									foreach ($getResult as $key => $about) {

									?>
										<input type="hidden" class="form-control" name="about_id" value="<?php echo $about['id'] ?>">

										<div class="form-group">
											<label class="control-label col-lg-2" for="title">Ttile</label>
											<div class="col-lg-10">
												<input type="text" id="title" class="form-control" name="title" required value="<?php echo $about['about_title'] ?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" id="sub_title" class="form-control" name="sub_title" required value="<?php echo $about['about_sub_title'] ?>">
											</div>
										</div>
										<div class="form-group">
											<label class="control-label col-lg-2" for="details">Details</label>
											<div class="col-lg-10">
												<textarea rows="5" cols="5" id="details" class="form-control" placeholder="Default textarea" name="details" required><?php echo $about['about_detals'] ?></textarea>
											</div>
										</div>
													...
													<div class="file-preview">
														...
														<div class="file-preview-thumbnails">
															<div class="file-preview-frame" id="preview-1656423988463-0">
																<img src="<?php echo '../uploads/aboutImage/' . $about['image'] ?>" class="file-preview-image" title="" alt="" style="width:auto;height:160px;">
															</div>
														</div>
								...
								<div class="text-right mb-10 mr-10">
									<button type="submit" name="updateAbout" class="btn btn-primary">Submit <i class="icon-arrow-right14 position-right"></i></button>
