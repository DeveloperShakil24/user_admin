        ...
        <ul class="navigation navigation-main navigation-accordion">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="<?php echo $isInternal == true ? '../designation/' : 'designation/'; ?>designationList.php">Designation</a></li>
                </ul>
            </li>
            ...
            <li class="<?php if ($page == 'about') { echo 'active'; } ?>"><a href="<?php echo $isInternal == true ? '../about_section/' : 'about_section/'; ?>aboutAdd.php"><i class=" icon-users4"></i> <span>About Section</span></a></li>

            <!-- <li><a href="#"><i class=" icon-users4"></i> <span>About Section</span></a></li> -->
