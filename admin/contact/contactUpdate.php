				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							$getSingelDataQry = "SELECT * FROM contact_us WHERE id={$contact_id}";
							$getResult = mysqli_query($dbCon, $getSingelDataQry);
							?>

							<form class="form-horizontal mt-10" action="../controller/ContactController.php" method="post">
								<fieldset class="content-group">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" id="contact_title" class="form-control" name="contact_title" required value="<?php echo $contact['contact_title'] ?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<textarea rows="5" cols="5" id="contact_detals" class="form-control" placeholder="Default textarea" name="contact_detals" required><?php echo $contact['contact_detals'] ?></textarea>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" id="icon_name" class="form-control" name="icon_name" required value="<?php echo $contact['icon_name'] ?>">
											</div>
										</div>
								...
								<div class="text-right">
									<button type="submit" name="updateContact" class="btn btn-primary">Submit <i class="icon-arrow-right14 position-right"></i></button>
