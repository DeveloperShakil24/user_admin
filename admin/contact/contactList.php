					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							...
							<div class="heading-elements">
								<ul class="icons-list">
									<li style="margin-right: 10px;"><a href="contactAdd.php" class="btn btn-primary add-new"> <i class=" icon-plus-circle2"> </i> Add New</a></li>
						...
						<div class="panel-body">
							...
							<table class="table datatable-basic table-bordered table-hover">
								...
								<tbody>
									...
									<?php
									$selectQry = "SELECT * FROM contact_us WHERE active_status=2";
									...
									?>
										<tr>
											...
											<td><?php echo $contact['contact_detals']; ?></td>
