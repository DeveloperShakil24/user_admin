				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal mt-10" action="../controller/designationController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" id="designation_name" class="form-control" name="designation_name">
										</div>
									</div>
								</fieldset>
								<div class="text-right">
									<button type="submit" name="saveDesignation" class="btn btn-primary">Submit <i class="icon-arrow-right14 position-right"></i></button>
