				...
				<div class="content">
					...
					<div class="panel panel-flat">
						<div class="panel-heading">
							<h5 class="panel-title">Services Create</h5>
						...
						<div class="panel-body">
							...
							<form class="form-horizontal mt-10" action="../controller/ServicesController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" id="icon_name" class="form-control" name="services_detals">
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-lg-2" for="services_detals">Services Detals</label>
										<div class="col-lg-10">
