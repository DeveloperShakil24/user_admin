<?php require_once('../admin/controller/dbConfig.php'); ?>
...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
  ...
  <section id="home-section" class="hero">
    <h3 class="vr">Welcome to SHAKIL</h3>
          ...
          <div class="slider-item js-fullheight">
            ...
            <div class="container-fluid p-0">
              <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
                <div class="one-third order-md-last img js-fullheight" style="background-image:url(<?php echo '../admin/uploads/bannerImage/' . $bannerItem['image']; ?>)">
                  <div class="overlay"></div>
                </div>
                ...
                <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                  <div class="text">
                    ...
                    <h1 class="mb-4 mt-3"><?php echo $bannerItem['sub_title'] ?></h1>
      ...
      <div class="row no-gutters">
        <div class="col-md-4 ftco-animate py-5 nav-link-wrap">
          <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <a class="nav-link px-4 active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true"><span class="mr-3 flaticon-ideas"></span> Business
              Strategy</a>
            ...
            <a class="nav-link px-4" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false"><span class="mr-3 flaticon-analysis"></span> Data
              Analysis</a>
            <a class="nav-link px-4" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab" aria-controls="v-pills-4" aria-selected="false"><span class="mr-3 flaticon-web-design"></span> UI
              Design</a>
            <a class="nav-link px-4" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4" role="tab" aria-controls="v-pills-4" aria-selected="false"><span class="mr-3 flaticon-ux-design"></span> Ux
              Design</a>
            <a class="nav-link px-4" id="v-pills-5-tab" data-toggle="pill" href="#v-pills-5" role="tab" aria-controls="v-pills-5" aria-selected="false"><span class="mr-3 flaticon-innovation"></span>
              Technology</a>
      ...
      <div class="row">
        <div class="col-md-12 testimonial">
          <div class="carousel-project owl-carousel">
            ...
            <?php
            // $projectDataSql = 'SELECT * FROM our_project';
            // $projectData = mysqli_query($dbCon, $projectDataSql);

            $projectDataSql = "SELECT our_project.*, categories.category_name FROM `our_project`
            ...
            ?>
                <div class="item">
                  <div class="project">
                    <div class="img">
                      <img src="<?php echo '../admin/uploads/projectThumb/' . $project['project_image']; ?>" class="img-fluid" alt="Colorlib Template">
                      <div class="text px-4">
                        <h3><a href="#"><?php echo $project['project_name']; ?></a></h3>
            ...
            <!-- <div class="item">
              <div class="project">
                <div class="img">
                  <img src="images/xproject-2.jpg.pagespeed.ic.d_wlp1pl3f.jpg" class="img-fluid" alt="Colorlib Template">
                  <div class="text px-4">
            ...
            <div class="item">
              <div class="project">
                <div class="img">
                  <img src="images/xproject-3.jpg.pagespeed.ic.7xydadbmqc.jpg" class="img-fluid" alt="Colorlib Template">
                  <div class="text px-4">
                    <h3><a href="#">Work Name</a></h3>
                    <span>Web Design</span>
                  </div>
            ...
            <div class="item">
              <div class="project">
                <div class="img">
                  <img src="images/xproject-4.jpg.pagespeed.ic.nyuprcadj0.jpg" class="img-fluid" alt="Colorlib Template">
                  <div class="text px-4">
                    <h3><a href="#">Work Name</a></h3>
                    <span>Web Design</span>
                  </div>
    ...
    <div class="container">
      <div class="row d-flex">
        <div class="col-md-6 col-lg-5 d-flex">
          <div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/xabout.jpg.pagespeed.ic.ddph6amxc8.jpg)">
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch" style="background-image:url(images/xstaff-1.jpg.pagespeed.ic.-caudx8oxf.jpg)"></div>
            </div>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch" style="background-image:url(images/xstaff-2.jpg.pagespeed.ic.ah2dkk40qg.jpg)"></div>
            </div>
            <div class="text d-flex align-items-center pt-3 text-center">
              <div>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch" style="background-image:url(images/xstaff-3.jpg.pagespeed.ic.ouqkobngee.jpg)"></div>
            </div>
            <div class="text d-flex align-items-center pt-3 text-center">
              <div>
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
          <div class="staff">
            <div class="img-wrap d-flex align-items-stretch">
              <div class="img align-self-stretch" style="background-image:url(images/xstaff-4.jpg.pagespeed.ic.rjllkc0xzz.jpg)"></div>
            </div>
            <div class="text d-flex align-items-center pt-3 text-center">
              <div>
      ...
      <div class="row d-flex">
        <div class="col-md-4 d-flex ftco-animate">
          <div class="blog-entry justify-content-end">
            <a href="single.html" class="block-20" style="background-image:url(images/ximage_1.jpg.pagespeed.ic.vf_don1zsh.jpg)">
            </a>
        ...
        <div class="col-md-4 d-flex ftco-animate">
          <div class="blog-entry justify-content-end">
            <a href="single.html" class="block-20" style="background-image:url(images/ximage_2.jpg.pagespeed.ic.mmfqd6zg2h.jpg)">
            </a>
            <div class="text mt-3 float-right d-block">
              <div class="d-flex align-items-center pt-2 mb-4 topp">
                <div class="one mr-2">
        ...
        <div class="col-md-4 d-flex ftco-animate">
          <div class="blog-entry">
            <a href="single.html" class="block-20" style="background-image:url(images/ximage_3.jpg.pagespeed.ic.trchucgaea.jpg)">
            </a>
            <div class="text mt-3 float-right d-block">
              <div class="d-flex align-items-center pt-2 mb-4 topp">
                <div class="one mr-2">
      ...
      <div class="row d-flex contact-info mb-5">
        ...
        <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          <div class="align-self-stretch box p-4 text-center">
            ...
            <p><a href="/#bdd4d3dbd2fdc4d2c8cfced4c9d893ded2d0"><span class="__cf_email__" data-cfemail="0d64636b624d7462787f7e647968236e6260">[email&#160;protected]</span></a></p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          <div class="align-self-stretch box p-4 text-center">
          ...
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                ...
                <li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span class="__cf_email__" data-cfemail="670e090108271e08121503080a060e094904080a">[email&#160;protected]</span></span></a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <script defer src="js/beacon.min.js" data-cf-beacon='{"rayId":"680bfffb4b68fdfe","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2021.8.1","si":10}'></script>
  <center>
    <font size="2">This is the free demo result. For a full version of this website, please go to <a href="https://www6.waybackmachinedownloader.com/website-downloader-online/scrape-all-files/">Website
        Downloader</a></font>
  </center>
</body>
